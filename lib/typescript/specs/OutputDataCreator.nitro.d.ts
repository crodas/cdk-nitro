 ...
 */
export interface OutputDataCreator extends HybridObject<{
    ios: 'c++';
    android: 'c++';
}> {
    createSingleRandomData(amount: number, keysetId: string): OutputData;
    createRandomData(amount: number, keysetId: string, keys: KeyEntry[], customSplit?: number[]): OutputData[];
    createSingleP2PKData(p2pk: P2PKOptions, amount: number, keysetId: string): OutputData;
    createP2PKData(p2pk: P2PKOptions, amount: number, keysetId: string, keys: KeyEntry[], customSplit?: number[]): OutputData[];
    createSingleDeterministicData(amount: number, seed: ArrayBuffer, counter: number, keysetId: string): OutputData;
    createDeterministicData(amount: number, seed: ArrayBuffer, counter: number, keysetId: string, keys: KeyEntry[], customSplit?: number[]): OutputData[];
}
//# sourceMappingURL=OutputDataCreator.nitro.d.ts.map