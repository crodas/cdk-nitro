...
export type { OutputData, KeyEntry, P2PKOptions, OutputDataCreator as OutputDataCreatorSpec, } from './specs/OutputDataCreator.nitro';
 ...
 */
export declare function createCashuOutputDataCreator(native: NativeOutputDataCreator): CdkOutputDataCreator;
